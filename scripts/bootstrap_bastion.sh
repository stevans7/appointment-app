...
cd /tmp && unzip awscliv2.zip && sudo ./aws/install || true

echo "Install kubectl"
curl -o /usr/local/bin/kubectl https://amazon-eks.s3.eu-central-1.amazonaws.com/1.27.3/2023-07-05/bin/linux/amd64/kubectl
